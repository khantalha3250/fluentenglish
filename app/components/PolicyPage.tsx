...
export default function Policies() {
  return (
    <div className=" bg-gradient-to-b from-softSkyBlue to-lightGray px-6 md:px-20 lg:px-40 py-10">
...
<br/><strong>LINKS TO THE OTHER SITES</strong><br/>
...
<br/><strong>INFORMATION SHARING</strong><br/>
We sharres the sensitive personal information to any third party without obtaining the prior consent of the user in the following limited circumstances:
...
However the internet is an ever evolving medium. We may change our Privacy Policy from time to time to incorporate necessary future changes. Of course, our use of any information we gather will always be consistent with the policy under which the information was collected, regardless of what the new policy may be.
        ...
        <section id="terms-and-conditions" className="mb-10 text-gray-700">
         <h2 className="text-deepBlue font-semibold mb-4 pt-12 text-xl sm:text-3xl lg:text-4xl">
          ...
          <p className="leading-7 mb-4 pt-2 text-sm sm:text-lg lg:text-xl">
            ...
            collectively refer to Fluentt English live Education and the terms
            "Visitor” ”User” refer to the users. This page states the Terms and
            Conditions under which you (Visitor) may visit this website{" "}
            <strong>“www.fluenttenglishlive.com”</strong>. Please read this page
            ...
            companies <strong>in India or abroad</strong>reserve their
          ...
          <details className="bg-soft-sky-blue px-4 py-3 rounded-md mb-4">
            ...
            <p className="text-sm mt-2">
              ...
              or account which the user is not authorised to access. Attempting
              ...
              authorisation Attempting to interfere with service to any user,
              ...
              products and or services. Violations of system or network security
              may result in civil or criminal liability. The business and / or
              its associate entities will have the right to investigate
              occurrences that they suspect as involving such violations and
              will have the right to involve, and cooperate with, law
              ...
              from or resulting from their use of www.omtigroup.com or their
              breach of the terms.
            </p>
          </details>
        ...
        <section id="refund-policy" className="mb-10 text-gray-700">
         <h2 className="text-deepBlue font-semibold mb-4 pt-12 text-xl sm:text-3xl lg:text-4xl">
          ...
          <p className="leading-7 mb-4 pt-2 text-sm sm:text-lg lg:text-xl">
            Our focus is complete customer satisfaction. Refunds are only
            processed if we fail to deliver the promised services and upon
          ...
          <details className="bg-soft-sky-blue px-4 py-3 rounded-md mb-4">
            ...
            <p className="text-sm mt-2">
              Customer satisfaction is our main priority. If we fail to provide
              services from our end, but the customer has paid for the service
              then customer will be liable to mention the same to us within 7
              days. If the customer changes its mind for the services taken, we
              will not be liable to cancel the service.
            </p>
          </details>
          ...
          <details className="bg-soft-sky-blue px-4 py-3 rounded-md mb-4">
            ...
            <p className="text-sm mt-2">
              Fluentt English will not be considered if there is a breach of its
        ...
        <section id="contact-info" className="mb-10 text-gray-700">
          ...
          <div className="">
          <p className="text-base leading-7 sm:text-sm lg:text-lg" >
            <strong>Office Address:</strong> 11/2 First Floor, Sakinaka
            Industrial Estate, Near Sakinaka Metro, Andheri East, 400072
          </p>
          <p className="text-base leading-7 sm:text-sm lg:text-lg">
            <strong>Phone:</strong> +91 8454974682 / +91 8928023260
          </p>
          <p className="text-base leading-7 sm:text-sm lg:text-lg">
            <strong>Email:</strong>{" "}
            <a
              href="mailto:support@fluenttenglishlive.com"
              className="text-primary hover:underline"
            >
              support@fluenttenglishlive.com
            </a>
          </p>
          </div>
        </section>
